...
define([
    ...
    var BUTTONS = 'dashboard search workspaces admin activity logout products user-profile'.split(' '),
        PANE_AUXILIARY = {
        ...
        MUTALLY_EXCLUSIVE_SWITCHES = [
            { names: ['dashboard', 'search', 'products', 'admin'], options: { allowCollapse: false } },
            { names: ['dashboard', 'search', 'products-full', 'admin'], options: { allowCollapse: false } }
        ],
    ...
    function Menubar() {
        ...
        registry.documentExtensionPoint('org.bigconnect.menubar',
            ...
            'http://docs.bigconnect.io/extension-points/front-end/menubar'
        );
